...
- **Fond** : `#EAF4EC`
- **Fichier de sortie** : `public/produits/p2.webp`
...
Sujet : un carton kraft ouvert rempli de bananes plantain vert-jaune, un régime de plantains posé devant.
...
```
FOND : #EAF4EC — SUJET : un carton kraft ouvert rempli de bananes plantain vert-jaune, un régime de plantains posé devant
```
