...
- **Fond** : `#EAF4EC`
- **Fichier de sortie** : `public/produits/p7.webp`
...
Sujet : un colis carton de gombos verts frais bien alignés, deux gombos coupés en rondelles devant.
...
```
FOND : #EAF4EC — SUJET : un colis carton de gombos verts frais bien alignés, deux gombos coupés en rondelles devant
```
