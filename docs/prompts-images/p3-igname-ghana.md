...
- **Fond** : `#EAF4EC`
- **Fichier de sortie** : `public/produits/p3.webp`
...
Sujet : trois grosses ignames du Ghana à écorce brune rugueuse posées devant un sac de jute ouvert rempli d'ignames.
...
```
FOND : #EAF4EC — SUJET : trois grosses ignames du Ghana à écorce brune rugueuse posées devant un sac de jute ouvert rempli d'ignames
```
