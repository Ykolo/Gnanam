...
- **Fond** : `#EAF4EC`
- **Fichier de sortie** : `public/produits/p6.webp`
...
Sujet : un colis carton rempli de petits piments antillais habanero brillants, jaunes, orange et rouges.
...
```
FOND : #EAF4EC — SUJET : un colis carton rempli de petits piments antillais habanero brillants, jaunes, orange et rouges
```
